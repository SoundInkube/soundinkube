        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription className="text-center">
              Join SoundInkube to access the full platform
            </CardDescription>
          </CardHeader>
          <CardContent>
            {(error || passwordError) && (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="MUSIC_PROFESSIONAL" id="professional" />
                    <Label htmlFor="professional" className="cursor-pointer">Music Professional</Label>
                  </div>
                </RadioGroup>
                <p className="text-sm text-gray-500">
                  {role === "CLIENT" 
                    ? "As a Client, you can book jam pads, courses, and interact with professionals." 
                    : "As a Music Professional, you can list services, manage bookings, and connect with clients."}
                </p>
              </div>
