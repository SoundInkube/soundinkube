...
type UserRole = "CLIENT" | "MUSIC_PROFESSIONAL" | "ARTIST_MANAGER" | "RECORD_LABEL";
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              >
                ...
                <div className="flex items-center space-x-3 p-4 rounded-lg border border-gray-600 hover:border-gray-500 transition-colors duration-200">
                  <RadioGroupItem value="ARTIST_MANAGER" id="manager" className="border-gray-500 text-netflix-red" />
                  <div className="flex-1">
                    <Label htmlFor="manager" className="cursor-pointer text-white font-medium">Artist Manager</Label>
                    <p className="text-sm text-gray-400 mt-1">Manage talent, scout artists, and oversee artist careers</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3 p-4 rounded-lg border border-gray-600 hover:border-gray-500 transition-colors duration-200">
                  <RadioGroupItem value="RECORD_LABEL" id="label" className="border-gray-500 text-netflix-red" />
                  <div className="flex-1">
                    <Label htmlFor="label" className="cursor-pointer text-white font-medium">Record Label</Label>
                    <p className="text-sm text-gray-400 mt-1">Discover artists, manage releases, and grow music business</p>
                  </div>
                </div>
              </RadioGroup>
            </div>
