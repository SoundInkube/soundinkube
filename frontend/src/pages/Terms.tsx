...
export default function Terms() {
  const sections = [
    ...
    {
      icon: <DollarSign className="text-white h-6 w-6 text-netflix-red" />,
    ...
    {
      icon: <AlertTriangle className="text-white h-6 w-6 text-netflix-red" />,
    ...
    {
      icon: <Scale className="text-white h-6 w-6 text-netflix-red" />,
    ...
    <div className="text-white min-h-screen bg-netflix-black pt-20">
      ...
      <div className="text-white max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <Card className="text-white netflix-card bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm mt-8">
          <CardHeader>
            <CardTitle className="text-white text-white text-xl">Service Availability & Changes</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-white text-white space-y-4">
              <p>
        ...
        <Card className="text-white netflix-card bg-gradient-to-br from-netflix-red/10 to-gray-900/50 backdrop-blur-sm mt-8 border-netflix-red/30">
          <CardHeader>
            <CardTitle className="text-white text-white text-xl">Questions About These Terms?</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-white text-white space-y-4">
              <p>
              ...
              <div className="text-white space-y-2">
                <p><strong className="text-white text-netflix-red">Email:</strong> legal@soundinkube.com</p>
                <p><strong className="text-white text-netflix-red">Address:</strong> SoundInkube, Inc., 123 Music Ave, Los Angeles, CA 90028</p>
                <p><strong className="text-white text-netflix-red">Business Hours:</strong> Monday-Friday, 9AM-5PM PST</p>
              </div>
