...
export default function Navbar() {
  ...
  const getNavigationItems = () => {
    ...
    } else if (user.role === "RECORD_LABEL") {
      return [
        { name: "Discover Artists", href: "/discover-artists", description: "Find new talent" },
        { name: "Manage Releases", href: "/manage-releases", description: "Track music releases" },
        { name: "Analytics", href: "/label-analytics", description: "Performance metrics" },
        { name: "Dashboard", href: "/dashboard", description: "Business operations" }
      ];
    }
  ...
  const getProfileDropdownItems = () => {
    ...
    if (user.role === "CLIENT") {
      ...
      return [
        { name: "Profile Settings", href: "/profile" },
        { name: "Artist Roster", href: "/artist-roster" },
        { name: "Release Schedule", href: "/release-schedule" },
        { name: "Label Analytics", href: "/label-analytics" },
        { name: "Contracts & Deals", href: "/contracts-deals" }
      ];
    }
                    ...
                    <DropdownMenuLabel className="text-gray-300">
                      ...
                      <div className="text-xs text-gray-500 mt-1 capitalize">
                        {user?.role === "ARTIST_MANAGER" ? "Artist Manager" : 
                         user?.role === "RECORD_LABEL" ? "Record Label" :
