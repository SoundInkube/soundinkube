      ...
      <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <Link to="/marketplace" className="text-base text-gray-600 hover:text-gray-900">
                  Marketplace
                </Link>
              </li>
              <li>
                <Link to="/jampads" className="text-base text-gray-600 hover:text-gray-900">
                  Jam Pads
                </Link>
              </li>
              <li>
                <Link to="/music-schools" className="text-base text-gray-600 hover:text-gray-900">
                  Music Schools
                </Link>
              </li>
              <li>
                <Link to="/collaborations" className="text-base text-gray-600 hover:text-gray-900">
                  Collaborations
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 border-t border-gray-200 pt-8 flex flex-col md:flex-row justify-between">
          <div className="flex items-center mb-4 md:mb-0">
            <span className="text-xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent mr-2">
              SoundInkube
            </span>
            <p className="text-gray-500 text-sm">
              © {currentYear} SoundInkube. All rights reserved.
            </p>
          </div>
