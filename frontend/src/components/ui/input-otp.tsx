  ...
  ({ index, className, ...props }, ref) => {
    ...
    return (
      ...
      >
        {char}
        {hasFakeCaret && (
          <div className="text-white pointer-events-none absolute inset-0 flex items-center justify-center">
            <div className="text-white h-4 w-px animate-caret-blink bg-foreground duration-1000" />
          </div>
        )}
      </div>
    );
